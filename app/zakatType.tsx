...
const zakatTypes = [
  {
    ...
    icon: { uri: 'https://cdn-icons-png.flaticon.com/128/2910/2910765.png' },
  },
  {
    name: 'Business Zakat Calculator',
    icon: { uri: 'https://cdn-icons-png.flaticon.com/128/2920/2920043.png' },
  },
  {
    name: 'Investment Shares Zakat Calculator',
    icon: { uri: 'https://cdn-icons-png.flaticon.com/128/5977/5977590.png' },
  },
  {
    name: 'Gold Zakat Calculator',
    icon: { uri: 'https://cdn-icons-png.flaticon.com/128/361/361998.png' },
  },
  {
    name: 'Silver Zakat Calculator',
    icon: { uri: 'https://cdn-icons-png.flaticon.com/128/2234/2234837.png' },
  },
  {
    name: 'Savings Zakat Calculator',
    icon: { uri: 'https://cdn-icons-png.flaticon.com/128/727/727399.png' },
  },
  {
    name: 'EPF Zakat Calculator',
    icon: { uri: 'https://cdn-icons-png.flaticon.com/128/1665/1665731.png' },
  },
];
