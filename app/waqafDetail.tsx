...
export default function DonationDetailScreen() {
  ...
  const { urlImage } = useLocalSearchParams();
      ...
      <View style={{ flex: 1}}>
        ...
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <Text style={styles.title}>
            Back to School: Bantuan Awal Persekolahan Anak-anak <Ionicons name="checkmark-circle" size={16} color="#2AA484" />
          </Text>
